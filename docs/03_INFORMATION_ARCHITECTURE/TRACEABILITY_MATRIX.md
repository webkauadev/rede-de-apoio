...
Fonte canônica incorporada ao GitHub a partir do Guia Mestre e atualizada pelas decisões aprovadas em 2026-09-14.
...
| RF23 | US-027 | E10 |
| RF24 | US-028 | T15 |
| RF25 | US-029 | N03 → T05/T07 |
| RF26 | US-030 | N04 → T05; resumo possível em T03 |
| RF27 | US-031 | T16 |
| RF28 | US-032 | T07/E13 — Familiar Principal |
| RF29 | US-033 | T17 |
| RNF01 | US-035 | E27/T17 |
| RNF02 | US-034 | E12 |
| RNF03 | transversal / influencia RF29 | T17 / auditoria |
| RF30 | US-036 | T01/T02 + T12 + estados read-only autorizados |

## Tela → User Stories

| Tela | Histórias principais |
|---|---|
| T01 | US-002; autenticação compartilhada com US-036 |
| T02 | US-001; ativação/cadastro compartilhado com US-036 |
...
## Decisões transversais aprovadas em 2026-09-14

- **P03 / #75:** escrita e correção dependem da permissão efetiva e das condições operacionais aprovadas.
- **P04 / #76:** N01–N04 usam feedback transitório global e destinos existentes; não existe Central de Notificações dedicada.
- **P05 / #77:** CSV em T07 é permitido somente ao Familiar Principal na primeira versão e deve ser auditado.
- **P06 / #78:** papéis familiares acumulados compõem permissão por união positiva, preservando restrições explícitas e condições contextuais.
- **RF30/#34 + US-036/#72:** acesso próprio da Pessoa Idosa aprovado em modo somente leitura, sem administração, escrita ou CSV.
...
Estados de configuração do acesso RF30 (não configurado, convite, convite enviado e acesso ativo) continuam estados de T12, não novas telas do Site Map.

## Regra de estados

`STATE = PAGE BASE + DELTA MÍNIMO`

Erro, loading, empty, success, forbidden, notificações transitórias e estados de configuração de acesso não viram páginas independentes do Site Map.
